...
interface StoreDistributionViewProps {
  data: Order[];
  stores: Store[];
...
const StoreDistributionView: React.FC<StoreDistributionViewProps> = ({ data, stores, onOrderClick }) => {
      ...
      <div className="matrix-container store-distribution">
        <div className="matrix-header">
          <div className="matrix-title">
            <span className="section-badge green">STORE DISTRIBUTION VIEW</span>
            <h3>By Store Location</h3>
          </div>
...
export default StoreDistributionView;
